...
- **PDF to upload:** `build/ssrn/terminal-value-ssrn.pdf` (107 pages, US Letter)
...
Samuel Safahi, Independent. samsafahi@gmail.com
...
SSRN's readership checks citations, so the 7 open attributions in the
