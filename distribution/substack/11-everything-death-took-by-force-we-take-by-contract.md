# Everything Death Took by Force, We Take by Contract

*The constructive half. Five mechanisms to replace five functions, each with its strongest objection printed next to it, and an argument about why the window for adopting any of them is now.*
